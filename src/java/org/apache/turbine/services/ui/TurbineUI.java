 ...
 * through static methods.  The {@link UIService} should ALWAYS be accessed via
 * either this class or {@link UITool}.
 *
...
public class TurbineUI
{
     ...
     * @return the {@link UIService} instance
     */
    ...
    {
        return getService().getSkinNames();
    }
    ...
    {
        return getService().getWebappSkinName();
    }
    ...
    {
        return getService().get(skinName, key);
    }
     ...
     * @param serverData the ServerData to use as
    ...
    {
        return getService().image(skinName, imageId, serverData);
    }
    ...
    public static String image(String skinName, String imageId)
    {
        return getService().image(skinName, imageId);
    }
    ...
    {
        return getService().getStylecss(skinName, serverData);
    }
    ...
    {
        return getService().getStylecss(skinName);
    }
    ...
    public static String getScript(String skinName, String filename)
    {
        return getService().getScript(skinName, filename);
    }
}
